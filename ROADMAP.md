...
### A11. Custom G-code per print Z — pause / color change / template 🟡 Shipped — JNI + MCP + persistence + 3MF round-trip; layer-scrubber tick UI deferred
