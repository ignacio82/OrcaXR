...
#ifndef __ORCAXR_TBB_SERIAL_PARALLEL_REDUCE_H
#define __ORCAXR_TBB_SERIAL_PARALLEL_REDUCE_H

#ifndef __TBB_parallel_reduce_H
#define __TBB_parallel_reduce_H 1
#endif
...
#endif /* __ORCAXR_TBB_SERIAL_PARALLEL_REDUCE_H */

#else  // ORCAXR_TBB_SERIAL_ACTIVE not defined: forward to real TBB

#include_next <tbb/parallel_reduce.h>
