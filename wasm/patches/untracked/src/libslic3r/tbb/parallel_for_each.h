...
#ifndef __ORCAXR_TBB_SERIAL_PARALLEL_FOR_EACH_H
#define __ORCAXR_TBB_SERIAL_PARALLEL_FOR_EACH_H

#ifndef __TBB_parallel_for_each_H
#define __TBB_parallel_for_each_H 1
#endif
...
#endif /* __ORCAXR_TBB_SERIAL_PARALLEL_FOR_EACH_H */

#else  // ORCAXR_TBB_SERIAL_ACTIVE not defined: forward to real TBB

#include_next <tbb/parallel_for_each.h>
