// OrcaXR WASM stubs — replaces the OCCT- (STEP/TextShape/svg) and
// draco- (DRC) backed importers in the WebAssembly build, where those
// libraries are not cross-compiled (v1 scope: STL/3MF/OBJ slicing).
