...
class ModelRenderer(private val context: Context) : GLSurfaceView.Renderer {
    ...
    /** XY position of the model's min-corner on the bed, in mm.
     *  When null, the model draws at its natural pose. */
    @Volatile var objectPosition: FloatArray? = null
    ...
    private fun drawModel(mesh: MeshData) {
        ...
        // Place the model on the bed. When objectPosition is set, the
        // model's scaled XY-min corner lands at (px, py); otherwise it
        // sits at the bed center. Z always rests on the bed (Z=0).
        ...
        Matrix.translateM(modelMatrix, 0, tx, ty, halfD * s[2])
