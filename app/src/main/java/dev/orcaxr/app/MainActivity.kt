    ...
    DisposableEffect(session, workspacePlacementEntity) {
        ...
        val visibilityListener =
            java.util.function.Consumer<androidx.xr.scenecore.SpatialVisibility> { visibility ->
                ...
                if (visibility == androidx.xr.scenecore.SpatialVisibility.WITHIN_FIELD_OF_VIEW) {
                    android.util.Log.i("OrcaXR", "Spatial visibility is WITHIN_FIELD_OF_VIEW, requesting Full Space Mode")
