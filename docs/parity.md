...
- [~] **P5.3.6 — Brim ears.** The placement gizmo P4.8 deferred: pick anchor points, author the
  ...
  - **Outstanding:** the pinned gizmo's on-model ear preview is not implemented, and all five
    actions declare an `xrUnsupportedReason`. The slice proof runs against the browser engine in
    Node; no hardware print has confirmed an ear physically holds a corner down (P8.6).
