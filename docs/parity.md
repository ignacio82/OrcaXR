...
- [~] **P8.3 — Implement all generic calibration generators and instructions.** Provide parameter
  ...
  - **Missing:** the parameter form has no DOM or XR surface yet. Slice, inspect, and export/send
    for the generic modes are not built, and neither are the contextual documentation links. The saved preset is
