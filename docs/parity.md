...
- [~] **P11.2 — Close every menu, toolbar, context, camera, and view gap.** File, Edit, View, Add,
  ...
  - **The classification pass (`EVID-124`):** the manifest's 205 upstream menu leaves were all
    ...
    five things: **98** are reached by a named local action, **7** through a panel rather than a
    catalogued action, **17** are submenu headings rather than items, **15** are deliberate
    adaptations citing the register entry that explains them, and **25** are absent and name the
    task that owes them. Adaptation and absence are kept apart deliberately — one says the item
  ...
  - **Missing:** neither the outline nor the navigator has had a visual review, and the 25 absent
    ...
    printability, scale-to-build-volume, and three primitives. Classification is not
    implementation, and this row claims only the former. The XR context menu is a **selection-scoped section**
