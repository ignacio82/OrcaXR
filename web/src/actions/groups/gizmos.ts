...
function tool(id: string, label: string, icon: string, hint: string, runProp: string, disclosure: 'menu' | 'toolbar' = 'menu'): Action {
  return {
    id,
    label,
    icon,
...
export const gizmoActions: Action[] = [
  ...
  tool('split_to_parts', 'Split to Parts', 'split_parts',
  ...
  tool('tool_support_paint', 'Support Painting', 'support_paint',
    'Paint support enforcers and blockers onto the mesh',
    'supportPaint', 'toolbar'),
  tool('tool_seam_paint', 'Seam Painting', 'seam_paint',
    'Paint where layer seams may / may not be placed',
    'seamPaint', 'toolbar'),
  tool('tool_fuzzy_skin', 'Fuzzy-skin Painting', 'fuzzy_skin',
    'Paint regions that should get a fuzzy surface',
    'fuzzySkin', 'toolbar'),
  tool('tool_smart_paint', 'Smart Paint', 'smart_paint',
    'AI-powered semantic painting',
    'smartPaint', 'toolbar'),
  tool('tool_smart_paint_image', 'Smart Paint (Image)', 'smart_paint_image',
    'AI-powered semantic painting using an image',
    'smartPaintImage', 'toolbar'),
  tool('tool_brim_ears', 'Brim Ears', 'brim_ears',
    'Place brim "mouse ears" at chosen points',
    'brimEars', 'toolbar'),
  tool('tool_measure', 'Measure', 'measure',
    'Measure distances and angles on the model',
    'measureTool', 'toolbar'),
  tool('tool_assembly', 'Assembly View', 'assembly',
    'Explode multi-part objects into an assembly view',
    'assemblyView', 'toolbar'),
  tool('tool_face_detector', 'Auto Face Orientation', 'face_detector',
    'Detect the best flat face and orient to it',
    'faceDetector', 'toolbar'),
  tool('tool_svg', 'SVG Emboss', 'svg',
    'Emboss / cut an SVG onto the model surface',
    'svgEmboss', 'toolbar'),
  tool('tool_hollow', 'Hollow', 'hollow',
    'Hollow the model with an internal shell',
    'hollowModel', 'toolbar'),

  // ---- Object context-menu ops (Orca right-click) ----
  tool('add_modifier', 'Add Modifier', 'modifier',
    'Add a modifier volume with per-region settings',
    'addModifier'),
  tool('add_support_enforcer', 'Add Support Enforcer', 'support_enforcer',
    'Add a volume that forces supports inside it',
    'addSupportEnforcer'),
  tool('add_support_blocker', 'Add Support Blocker', 'support_blocker',
    'Add a volume that blocks supports inside it',
    'addSupportBlocker'),
  tool('add_height_range', 'Add Height-range Modifier', 'height_range',
    'Override settings for a Z height range',
    'addHeightRange'),
  tool('set_negative_part', 'Set as Negative Part', 'negative_part',
    'Turn the selected part into a negative (cut) volume',
    'setNegativePart'),
  tool('variable_layer_height', 'Variable Layer Height', 'layers_edit',
