...
export const ACTION_IDS_BY_PARITY_TASK = {
  ...
  'P8.3': [
    ...
    'calib_input_shaping_frequency',
    'calib_input_shaping_damping',
  ],
  ...
  'P10.4': ['help_language'],
  'P11.1': ['file_new_project', 'file_open_project', 'file_open_recent', 'file_save_project', 'file_save_project_as'],
  'P11.2': [
    'view_camera_default',
    'view_camera_top',
    'view_camera_front',
