...
export const ACTION_IDS_BY_PARITY_TASK = {
  ...
  'P2.4': ['add_modifier', 'add_support_enforcer', 'add_support_blocker', 'set_negative_part'],
  'P2.5': ['add_height_range'],
  'P4.3': ['tool_paint'],
  ...
  'P5.4': ['add_plate', 'delete_plate', 'duplicate_plate'],
